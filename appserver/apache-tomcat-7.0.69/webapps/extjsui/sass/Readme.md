...
folder are mapped to the application's root namespace, 'ExtJSTrainingTwo'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJSTrainingTwo"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJSTrainingTwo' in the same way
as `"ExtJSTrainingTwo/sass/src"`.
